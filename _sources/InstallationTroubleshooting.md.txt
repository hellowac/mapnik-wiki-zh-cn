...
* *Solution*: This is the first C++ program that Scons 'finds' by actually compiling a sample program that links to it. *A g++ compiler* is therefore *required* for this step. On linux do `apt-get install g++` and on Mac os make sure you've installed XCode from the apple dev site.
